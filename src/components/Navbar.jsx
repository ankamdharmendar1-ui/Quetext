    ...
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 navbar-blur ${scrolled ? 'shadow-2xl shadow-black/30' : ''}`}>
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            <Link to="/contact" className="text-gray-400 hover:text-white text-sm font-medium transition-colors duration-300">Contact Us</Link>
            <Link to="/privacy-policy" className="text-gray-400 hover:text-white text-sm font-medium transition-colors duration-300">Privacy Policy</Link>
      ...
      <div className={`md:hidden transition-all duration-500 overflow-hidden ${isMenuOpen ? 'max-h-screen opacity-100' : 'max-h-0 opacity-0'}`}>
        <div className="navbar-blur border-t border-white/10 px-4 py-4 space-y-1">
          ...
          <Link to="/contact" className="block px-4 py-3 rounded-xl text-sm font-medium text-gray-300 hover:text-white hover:bg-white/10">Contact Us</Link>
          <Link to="/privacy-policy" className="block px-4 py-3 rounded-xl text-sm font-medium text-gray-300 hover:text-white hover:bg-white/10">Privacy Policy</Link>
