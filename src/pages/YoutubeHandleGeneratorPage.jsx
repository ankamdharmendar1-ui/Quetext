  ...
  return (
    <div className="max-w-4xl mx-auto p-4 py-12">
      <Helmet>
        ...
        <meta name="keywords" content="youtube handle generator, youtube name generator, youtube channel name generator, youtube handle ideas, youtube username generator, free youtube handle generator, channel name ideas" />
      ...
      <SEO
        ...
        description="Generate unique and catchy YouTube handles for your channel with our free YouTube Handle Generator. Find the perfect @name for your brand."
        keywords="youtube handle generator, youtube name generator, youtube channel name generator, youtube handle ideas, youtube username generator, free youtube handle generator, channel name ideas"
